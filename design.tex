...
complexity, and NH requires a long key which needs to be derived and cached. For
this work we primarily target processors where polynomial evaluation is fast, so

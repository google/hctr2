...
\begin{align*}
    ...
    = & \left.\left(2\binom{\sigma}{2} + 4\sigma + 2 + 2(\sigma - q) + (q-1)\sigma + \binom{\sigma}{2} -1\right)\middle/2^n\right. \\
    = & \left.\left(3\sigma(\sigma - 1)/2 + (q + 5)\sigma - 2q + 1\right)\middle/2^n\right. \\
    \leq & \left.\left(3\sigma^2 + (2q + 10)\sigma + 2\right)\middle/2^{n+1}\right. \\
\end{align*}
...
\begin{align*}
    ...
    &+ \left.\left(3\sigma^2 + (2q + 10)\sigma + q^2 + 2\right)\middle/2^{n+1}\right. \\
\end{align*}

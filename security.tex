...
\begin{align*}
    ...
    \leq &
        \Bigg(\sum_{a, b \in \mathcal{D}} \prob{a = b}\Bigg)
      + \Bigg(\sum_{a, b \in \mathcal{R}} \prob{a = b}\Bigg)
      \\
    = &\left.\left(2\binom{\sigma_m}{2} + c
    \right)\middle/2^n\right. \\
    \intertext{where}
    c \defeq &
    \Bigg(\sum_{a, b \in \mathcal{D}} 2^n\prob{a = b} -1\Bigg)
    + \Bigg(\sum_{a, b \in \mathcal{R}} 2^n\prob{a = b} -1\Bigg)
\end{align*}

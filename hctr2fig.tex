...
\begin{tikzpicture}
  ...
  \node[rectangle] at (5,-3) (T) {$T$};
  \node[XOR] at (1.5, -3) (XS) {};
  \node[rectangle] at (0.75,-3) (L) {\(L\)};
  \node[cbox] at (2.75,-3) (XCTR) {$\XCTR_k$};
  \node[XOR] at (N |- XCTR) (X2) {};
  \node[cbox] at (1,-5) (H3) {$H_h$};
  \node[XOR] at (M |- H3) (X3) {};
  \node[rectangle] at (0,-6) (V) {$V$};
  \node[rectangle] at (X2 |- V) (W) {$W$};
  \draw[wire] (M) -- (X1);
  \draw[wire] (N) -- (X2);
